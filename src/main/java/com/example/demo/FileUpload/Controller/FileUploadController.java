...
//        String base  = "D:/Documentos/";
    ...
    public ResponseEntity<Object> saveMultipleFiles(@RequestParam("registro") String strRegistro, @RequestParam("fichero") MultipartFile[] multipartFiles) {
        ...
        Gson gson = new Gson();
        FileStructure registro = gson.fromJson(strRegistro, FileStructure.class);
//        String uploadDir = "D:/Documentos/" + registro.getSubCarpeta();
        String uploadDir = "C:/Users/jaim.martinez/Desktop/VENTANILLA/" + registro.getSubCarpeta();
//      String uploadDir = "/media/compartida/" + registro.getSubCarpeta()+"/";
